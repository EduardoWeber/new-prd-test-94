"""
Django settings for new_prd_test_94 project.
...
ROOT_URLCONF = 'new_prd_test_94.urls'
...
WSGI_APPLICATION = 'new_prd_test_94.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "new_prd_test_94 API",
    "DESCRIPTION": "API documentation for new_prd_test_94 App",
    "VERSION": "v1",
}
